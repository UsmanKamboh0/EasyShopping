...
const { error, product } = MenproductDetails;
  const {
    loading,
    error: updateError,
    isUpdated,
  } = useSelector((state) => state.MenproductEdit);
  ...
  const updateProductSubmitHandler = (e) => {
    ...
    dispatch(updateMenProduct(productId, myForm));
  };
    ...
    <Fragment>
        ...
        <form onSubmit={updateProductSubmitHandler}>
          <div className="content-header">
            ...
            <h2 className="content-title">Edit Men Product</h2>
            <div>
