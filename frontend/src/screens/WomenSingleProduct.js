...
import {
  newWomenReview, WomenlistProductDetails,
...
import { addWomenItemsToCart } from "../Redux/Actions/cartActions";
...
const WomenSingleProduct = ({ match }) => {
  ...
  const { loading, error, product } = WomenproductDetails;
  ...
  const reviewSubmitHandler = () => {
    ...
    dispatch(newWomenReview(myForm));
  ...
  useEffect(() => {
    ...
    dispatch(WomenlistProductDetails(productId));
